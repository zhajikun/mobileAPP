package com.appspdeveloperblogapp.ws.shared;
...
public class AmazonSES {
   //This address must be verified with Amazon SES
    final String FROM = "jikunzha@gmail.com";
    ...
    final String HTMLBODY = "<h1>Please verify your email address</h1>"
            ...
            + "<a href='http://ec2-18-212-140-185.compute-1.amazonaws.com:8080/verification-service/email-verification.html?token=$tokenValue'>"
    ...
    final String TEXTBODY = "Please verify your email address. "
            ...
            + " http://ec2-18-212-140-185.compute-1.amazonaws.com:8080/verification-service/email-verification.html?token=$tokenValue"
            + " Thank you! And we are waiting for you inside!";
